...
(during installation choose install all subfeatures on hard drive for both selections)
...
5) Run the "settings.bat"(preferable) or "EM Oscillations.exe" executable.